...
class CheckoutDraftConversionTest {
  ...
  void verifiedPaymentConvertsDraftIntoPaidOrderAndCommitsReservation() {
    ...
    var draft = CheckoutDraftEntity.open(UUID.randomUUID(), new CheckoutContracts.ShippingAddress("Name", "Line", null, "City", "Region", "00000", "US"), new CheckoutContracts.AuthoritativeTotal(100, 0, 0, 100, "USD"), Instant.now().plusSeconds(60));
