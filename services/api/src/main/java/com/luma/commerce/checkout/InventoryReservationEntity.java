...
public class InventoryReservationEntity {
  ...
  public static InventoryReservationEntity reserveForDraft(UUID draftId, UUID productId, int quantity, Instant expiresAt) { var reservation = new InventoryReservationEntity(); reservation.id = UUID.randomUUID(); reservation.draftId = draftId; reservation.productId = productId; reservation.quantity = quantity; reservation.status = "RESERVED"; reservation.expiresAt = expiresAt; return reservation; }
  public String getStatus() { return status; }
  public UUID getOrderId() { return orderId; }
  public UUID getDraftId() { return draftId; }
  public UUID getProductId() { return productId; }
  public int getQuantity() { return quantity; }
  public void attachOrder(UUID orderId) { if (this.orderId != null || this.draftId == null) throw new IllegalStateException("Reservation ownership cannot be transferred"); this.orderId = orderId; this.draftId = null; }
